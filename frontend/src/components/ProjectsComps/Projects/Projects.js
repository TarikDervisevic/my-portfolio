...
const Projects = (props) => {
    const projectList = [
        {name: "PixelStore", desc: "A responsive online store made with the MERN stack", link: "https://salty-eyrie-09068.herokuapp.com", imgURL: "https://i.imgur.com/TW7A8T2.png"},
